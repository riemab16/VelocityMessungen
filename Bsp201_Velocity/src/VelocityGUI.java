...
public class VelocityGUI extends javax.swing.JFrame {
    ...
    public VelocityGUI() {
        initComponents();
        this.tbAusgabe.setModel(model);
        tbAusgabe.setDefaultRenderer(Object.class, new VelocityTableCellRenderer());
        model.add(new Measurement(LocalDateTime.now(), "Raser-Test", 90, 100));
    }
    ...
    private void mDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mDeleteActionPerformed
        model.delete(tbAusgabe.getSelectedRows());
    ...
    private void mAvgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mAvgActionPerformed
        JOptionPane.showMessageDialog(null, model.avgÜbertretung());
